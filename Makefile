...
MAINOBJ = main.o
FLOOROBJ = chamber.o position.o grid.o door.o empty.o floor.o hwall.o passageway.o stair.o tile.o vmall.o gamesubject.o
CHAROBJ = character.o
PLAYEROBJ = playerCharacter.o shade.o goblin.o troll.o drow.o vampire.o
NPCOBJ = npc.o dragon.o dwarf.o elf.o halfing.o human.o merchant.o orc.o
